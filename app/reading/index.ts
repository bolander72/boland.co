export const readings = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: 'https://momus.ca/were-alive-pablo-is-dead/'
      },
      {
      ...
      },
      {
        ...
        authors: ['George203'],
        link: 'https://george203.substack.com/p/bitcoin-has-a-scaling-issue/'
      },
      {
        title: 'Apps as Expressions of Style',
        authors: ['Valerie Tetu'],
        link: 'https://valtetu.framer.website/blog/apps-as-expressions-of-style/'
      },
      {
        title: 'Great Products Have Great Premises',
        authors: ['Anu Atluru', 'Bharat Kilaru'],
        link: 'https://www.workingtheorys.com/p/premise/'
      },
      {
        title: 'On Scope Creep & ZIRP Lessons',
        authors: ['Michael Dempsey'],
        link: 'https://mhdempsey.substack.com/p/on-scope-creep-and-zirp-lessons/'
      },
      {
      ...
      {
        title: "Crypto's Three-Body Problem",
        authors: ['Laura Lotti', 'Sam Hart', 'Toby Shorin'],
        link: 'https://otherinter.net/research/three-body-problem/'
      },
      {
