  ...
  return (
    <main>
      <section className='space-y-6'>
        ...
        <Paragraph>As a developer, I build applications across web and mobile, do contract work for various clients, and build startups and side projects. To see more, please head to my <Link href='/work' className='underline text-blue-600'>work</Link> page.</Paragraph>
