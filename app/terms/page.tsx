      ...
      <div className="bg-easyWhite px-2 pt-6">
         <div className="mx-auto max-w-3xl text-base leading-7 text-easyBlack normal-case">
            ...
            <div className="mt-10 max-w-2xl text-lg">
               ...
               <p className="mt-4">
                  Website Access: We grant you a limited, non-exclusive, and non-transferable right to access and use our website for personal and non-commercial purposes. You agree not to interfere with the functioning of our website or disrupt the experience of other users.
               </p>
               <p className="mt-4">
                  User Content: If you submit or share any content on our website, such as comments or testimonials, you retain ownership of that content. However, you grant us a worldwide, royalty-free, and non-exclusive license to use, reproduce, modify, adapt, publish, translate, and distribute that content for promotional and marketing purposes related to our services.
               </p>
            </div>
            <div className="mt-10 max-w-2xl text-lg">
               ...
               <p className="mt-4">
                  Communication: We will maintain open and timely communication with you throughout the duration of our services. It is important that you provide accurate and complete information to facilitate the smooth delivery of our services.
               </p>
               <p className="mt-4">
                  Confidentiality: We respect the confidentiality of any proprietary or sensitive information you share with us. We will not disclose such information to third parties without your consent, except as required by law.
               </p>
               <p className="mt-4">
                  Third-Party Services: In some cases, we may engage third-party service providers to assist in delivering our services. We will ensure that these providers maintain the same level of confidentiality and professionalism as outlined in our agreement with you.
               </p>
            </div>
            <div className="mt-10 max-w-2xl text-lg">
               ...
               <p className="mt-4">
                  Service Performance: We make every effort to deliver our services with professionalism and expertise. However, we cannot guarantee specific outcomes or results, as they may be influenced by factors beyond our control.
               </p>
               <p className="mt-4">
                  Indemnification: You agree to indemnify and hold Boland Co. and its affiliates, employees, and agents harmless from any claims, damages, or expenses arising out of your use of our website or services, or any violation of these terms.
               </p>
            </div>
            <div className="mt-10 max-w-2xl text-lg">
