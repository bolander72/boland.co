...
<div>
  ...
  <div className='text-sm text-muted-foreground'>Chainsmiths Bitcoin hackathon, OpenResearch team</div>
...
<div>
  ...
  <div className='text-sm text-muted-foreground'>South East European University, blockchain lecture</div>
  <div className='text-sm text-muted-foreground'>November 2017, North Macedonia</div>
</div>
...
There are still employers and potential business partners out there willing to take a chance on you. Often, these are people who remember those who took a chance on them. We do exist. We're out here.
