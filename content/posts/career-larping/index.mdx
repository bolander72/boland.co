...
<div>
  ...
  <div className='text-xs text-primary/85'>Chainsmiths Bitcoin hackathon, OpenResearch team</div>
  <div className='text-xs text-primary/85'>November 2016, Ireland</div>
</div>
...
<div>
  ...
  <div className='text-xs text-primary/85'>South East European University, blockchain lecture</div>
  <div className='text-xs text-primary/85'>November 2017, North Macedonia</div>
</div>
