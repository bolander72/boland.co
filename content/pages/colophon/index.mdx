...
I've struggled over the years presenting my site as a personal blog or a more professional portfolio. Hell, when I first bought this domain I built the site as a productized sales page offering software development and product design services.
...
As you can see, this site is pretty miminal. That is an intentional choice. Could I litter the page with animations, throw in subtle SVG backgrounds, and hijack your scroll behavior and cursor? Yeah, I guess.
...
Taken from [Joodaloop](https://joodaloop.com/colophon) referencing Carl Barenburg's rebellious article defining [Brutalist Web Design](https://carlbarenbrug.com/brutalist-web-design), I consciously choose (because I like it) to adopt most parts of the _brutalism code of practice_:
...
If I'm being honest, as a developer-by-trade, the more intricate the codebase, the more likely I am to tinker with code than write.
...
- System (defaults) - If it ain't broke...
