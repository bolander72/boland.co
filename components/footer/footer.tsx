  ...
  return (
    <footer className='mt-36'>
      <div className='mx-auto overflow-hidden px-6 py-6'>
        ...
        <p className='text-md mt-6 flex items-center justify-center text-center normal-case leading-5 text-easyBlack'>
          &copy; {new Date().getFullYear()} Boland Group, LLC
          <Image src='/icons/illinois.svg' alt='IL' width={30} height={30} />
          All rights reserved.
        </p>
        <div className='flex justify-center space-x-4 normal-case'>
          <Link
            href='/privacy'
            className='text-sm leading-6 text-easyBlack underline'
          >
            Privacy Policy
          </Link>
          <Link
