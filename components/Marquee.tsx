...
export default function Marquee() {
   return (
      <section className='flex flex-col items-stretch my-12'>
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FD49A0] to-[#000000] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
                  href="https://sexy.ai"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#DF2266] to-[#06001E] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#369999] to-[#9044DC] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#8BA242] to-[#2A5137] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyBlack">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FA9556] to-[#FA6E62] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyBlack">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#1966FF] to-[#000000] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
                  href="https://the.com/"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FFC728] to-[#8D1D40] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyBlack">
               <Link
                  target="_blank"
                  href="https://asu.edu"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FFF202] to-[#242424] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyBlack">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#E21C11] to-[#000000] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FAB303] to-[#E61845] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyBlack">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#0073D3] to-[#000000] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#17ABDA] to-[#2C0A3D] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#FE0000] to-[#3B3C43] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
         ...
         <div className="flex items-start px-6 py-3 bg-gradient-to-r from-[#0555FB] to-[#1E1A35] border-b hover:opacity-90">
            <div className="text-sm leading-6 text-easyWhite">
               <Link
                  target="_blank"
