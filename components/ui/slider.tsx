...
>(({ className, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track
      className='relative h-2 w-full grow overflow-hidden rounded-full bg-neutral-100
        dark:bg-neutral-800'
    >
      <SliderPrimitive.Range className='absolute h-full bg-neutral-900 dark:bg-neutral-50' />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb
      className='block h-5 w-5 rounded-full border-2 border-neutral-900 bg-white
